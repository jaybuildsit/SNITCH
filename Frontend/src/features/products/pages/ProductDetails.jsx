...
const ProductDetails = () => {
    ...
    // =========================================
    // AVAILABLE SIZES + CONCRETE VARIANT
    // =========================================
    ...
    if (selectedColor && variants.length > 0) {
        ...
        colorVariants.forEach((variant) => {
            getVariantSizesList(variant).forEach((size) => {
                if (size) {
                    sizesSet.add(size);
                }
            });
    ...
    if (selectedColor && variants.length > 0) {
        concreteVariant = variants.find((v) => {
            ...
            if (selectedSize) {
                ...
                return sizesList.includes(selectedSize);
            }
    ...
    const concreteStock =
        concreteVariant?.stock ?? null;

    const concreteVariantImage = getImageUrl(
        concreteVariant?.images?.[0]
    );
