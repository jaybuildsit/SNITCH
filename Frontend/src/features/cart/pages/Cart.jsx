                ...
                <div className="mt-10 grid gap-12 lg:grid-cols-[1fr_360px]">
                    ...
                    <aside className="lg:sticky lg:top-8 lg:self-start">
                        <div className="border-t border-black pt-6">
                            ...
                            <button className="mt-8 flex h-14 w-full items-center justify-center bg-black text-xs font-medium uppercase tracking-[0.22em] text-white transition hover:bg-black/85">
                                Proceed to Checkout
                            </button>
